  ...
  return (
    <div className="terms">
      ...
      <div className="termBottom">
          <form className="termForm">
              <div className="termFormLeft">
              ...
              <div className="termFormRight">
                  <div className="termUpload">
                      <img src={Logo} alt="" className="termUploadImg" />
                      <label for="file">
                          <Publish/>
                      </label>
                      <input type="file" id="file" style={{display:"none"}} />
                  </div>
                  <button className="termButton">Update</button>
              </div>
          </form>
      </div>
    </div>
